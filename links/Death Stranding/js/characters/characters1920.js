...
function moreInfo() {
   ...
   if(counter === 0) {
      ...
      document.querySelector(".lastAdjustment").style.width = "22.65vw";
      document.querySelector(".lastAdjustment").style.left = "45vw";
      document.querySelector(".lastAdjustment").style.top = "-4vw";
      // Редактирование положения второй картинки
      document.querySelector(".adjustment").style.top = "0";
      document.querySelector(".adjustment").style.left = "73vw";
      document.querySelector(".adjustment").style.width = "23.5vw";
            // Редактирование положение описалок и их содержимого
      // #1
      document.querySelector(".diy").style.top = "0vh";
      ...
      // #2
      document.querySelector(".bb").style.top = "18vh";
      ...
      // #3
      document.querySelector(".suitcase").style.top = "48vh";
      document.querySelector(".suitcase").style.left = "64.5vw";
      document.querySelector(".suitcase").style.display = "flex";
      document.getElementById('thirdDescriptor').innerHTML = "suitcase";
      // #4
      document.querySelector(".leg").style.top = "72vh";
      ...
      // #5
      document.querySelector(".equipment").style.top = "3vh";
   ...
   if(counter === 1) {
      ...
      document.querySelector(".lastAdjustment").style.width = "22.65vw";
      document.querySelector(".lastAdjustment").style.left = "43vw";
      document.querySelector(".lastAdjustment").style.top = "-8vw";
      // Редактирование положения второй картинки
      document.querySelector(".adjustment").style.top = "0";
      document.querySelector(".adjustment").style.left = "73vw";
      document.querySelector(".adjustment").style.width = "23.5vw";
      ...
      // #4
      document.querySelector(".leg").style.top = "63vh";
      document.querySelector(".leg").style.left = "71vw";
      document.querySelector(".leg").style.display = "flex";
   ...
   if(counter === 2) {
      ...
      document.querySelector(".lastAdjustment").style.width = "22vw";
      document.querySelector(".lastAdjustment").style.left = "45vw";
      document.querySelector(".lastAdjustment").style.top = "-4vw";
      // Редактирование положения второй картинки
      document.querySelector(".adjustment").style.top = "-4vw";
      document.querySelector(".adjustment").style.left = "77vw";
      document.querySelector(".adjustment").style.width = "19vw";
      // Редактирование положение описалок и их содержимого
      // #1
      document.querySelector(".diy").style.top = "2vh";
      ...
      document.getElementById('secondDescriptor').innerHTML = "suitcase";
      // #3
      document.querySelector(".suitcase").style.top = "47vh";
   ...
   if(counter === 3) {
      ...
      // #3
      document.querySelector(".suitcase").style.display = "flex";
      document.querySelector(".suitcase").style.top = "2vh";
      document.querySelector(".suitcase").style.left = "94vw";
      document.getElementById('thirdDescriptor').innerHTML = "Odradek mkI";
      // #4
      document.querySelector(".leg").style.display = "flex";
      document.querySelector(".leg").style.top = "50vh";
      document.querySelector(".leg").style.left = "70vw";
      document.getElementById('fourDescriptor').innerHTML = "combat suit";
      // #5
      document.querySelector(".equipment").style.display = "flex";
      document.querySelector(".equipment").style.top = "4vh";
      document.querySelector(".equipment").style.left = "72vw";
