...
function moreInfo() {
   ...
   if(counter === 0) {
      ...
      document.querySelector(".lastAdjustment").style.width = "46vw";
      document.querySelector(".lastAdjustment").style.left = "46vw";
      document.querySelector(".lastAdjustment").style.top = "5vw";
      // Редактирование положения второй картинки
      document.querySelector(".adjustment").style.display = "none";
      document.querySelector(".adjustment").style.top = "43vw";
      document.querySelector(".adjustment").style.left = "63vw";
      document.querySelector(".adjustment").style.width = "36vw";
            // Редактирование положение описалок и их содержимого
      // #1
      document.querySelector(".diy").style.top = "6vh";
      document.querySelector(".diy").style.left = "84vw";
      ...
      document.querySelector(".suitcase").style.left = "85vw";
      ...
      document.querySelector(".leg").style.left = "46vw";
   ...
   if(counter === 1) {
      ...
      document.querySelector(".lastAdjustment").style.width = "46vw";
      document.querySelector(".lastAdjustment").style.left = "40vw";
      document.querySelector(".lastAdjustment").style.top = "0vw";
      // Редактирование положения второй картинки
      document.querySelector(".adjustment").style.display = "none";
   ...
   if(counter === 2) {
      ...
      document.querySelector(".lastAdjustment").style.width = "44vw";
      ...
      document.querySelector(".diy").style.left = "72vw";
      document.querySelector(".diy").style.display = "flex";
      ...
      document.getElementById('secondDescriptor').innerHTML = "suitcase";
      // #3
      document.querySelector(".suitcase").style.top = "22vh";
      document.querySelector(".suitcase").style.left = "52vw";
   ...
   if(counter === 3) {
      ...
      document.querySelector(".lastAdjustment").style.width = "58vw";
      ...
      // #3
      document.querySelector(".suitcase").style.display = "flex";
      document.querySelector(".suitcase").style.top = "9vh";
      document.querySelector(".suitcase").style.left = "78vw";
      ...
      document.querySelector(".equipment").style.display = "flex";
      document.querySelector(".equipment").style.top = "6vh";
      document.querySelector(".equipment").style.left = "48vw";
