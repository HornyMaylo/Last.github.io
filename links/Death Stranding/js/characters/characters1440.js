...
function moreInfo() {
   ...
   if(counter === 0) {
      ...
      document.querySelector(".leg").style.left = "75vw";
   ...
   if(counter === 1) {
      ...
      // Редактирование положения второй картинки
      document.querySelector(".adjustment").style.top = "6vw";
      document.querySelector(".adjustment").style.left = "73vw";
      document.querySelector(".adjustment").style.width = "23.5vw";
      // Редактирование положение описалок и их содержимого
      // #1
      ...
      // #4
      document.querySelector(".leg").style.top = "60vh";
      ...
      document.querySelector(".equipment").style.left = "73vw";
      document.querySelector(".bb").style.display = "flex";
   ...
   if(counter === 2) {
      ...
      // Редактирование положение описалок и их содержимого
      // #1
      document.querySelector(".diy").style.top = "10vh";
      ...
      document.getElementById('secondDescriptor').innerHTML = "suitcase";
      // #3
      document.querySelector(".suitcase").style.top = "45vh";
   ...
   if(counter === 3) {
      ...
      // #3
      document.querySelector(".suitcase").style.display = "flex";
      document.querySelector(".suitcase").style.top = "12vh";
